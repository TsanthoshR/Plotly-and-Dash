...
app.layout = html.Div(
    [
        ...
        html.P(
            [
                "This Dashboard shows the happiness score/rank",
                html.Br(),
                html.A(
        ...
        dcc.RadioItems(id="Region_Radio", options=Regions, value="North America"),
...
def updateGraph(button_click,selected_country, selected_graph ):
    ...
    return (
        line_fig,
        f"the average value of {selected_graph} for {selected_country} is {avg_val}",
    )
